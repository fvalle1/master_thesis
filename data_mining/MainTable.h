...
public:
    ...
    uint64_t get(uint64_t component, uint64_t realization){
        if(component<fNComponents&&realization<fNRealizations) return fData[fNRealizations*component+realization]?1:0;
        else return 0;
    };
